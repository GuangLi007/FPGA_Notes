...
| 笔记 | 关联点 |
|------|--------|
| [[15FPGA ROM 详解]] | DDS 的核心是波形 ROM，ROM 是实现基础 |
| [[16FPGA FIFO 详解]] | 连续输出数据流可用 FIFO 缓存 |
| [[13查找表在FPGA中的应用与设计技巧]] | DDS 查表即查找表的经典应用 |
| [[9呼吸灯PWM设计]] | PWM + 低通滤波可替代 DAC 实现简易 DDS |
| [[4线性序列机原理与应用]] | 相位累加器本质是线性序列机 |
